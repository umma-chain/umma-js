...
import { Module as UmmachainUmmacoreConfigurationV1Beta1, msgTypes as UmmachainUmmacoreConfigurationV1Beta1MsgTypes } from "./ummachain.ummacore.configuration.v1beta1";
import { Module as UmmachainUmmacoreEscrowV1Beta1, msgTypes as UmmachainUmmacoreEscrowV1Beta1MsgTypes } from "./ummachain.ummacore.escrow.v1beta1";
import { Module as UmmachainUmmacoreFactory, msgTypes as UmmachainUmmacoreFactoryMsgTypes } from "./ummachain.ummacore.factory";
import { Module as UmmachainUmmacoreMint, msgTypes as UmmachainUmmacoreMintMsgTypes } from "./ummachain.ummacore.mint";
import { Module as UmmachainUmmacoreStarnameV1Beta1, msgTypes as UmmachainUmmacoreStarnameV1Beta1MsgTypes } from "./ummachain.ummacore.starname.v1beta1";

const LCDClient = IgniteClient.plugin([
  CosmosAuthV1Beta1, CosmosAuthzV1Beta1, CosmosBankV1Beta1, CosmosBaseTendermintV1Beta1, CosmosCrisisV1Beta1, CosmosDistributionV1Beta1, CosmosEvidenceV1Beta1, CosmosFeegrantV1Beta1, CosmosGovV1Beta1, CosmosParamsV1Beta1, CosmosSlashingV1Beta1, CosmosStakingV1Beta1, CosmosTxV1Beta1, CosmosUpgradeV1Beta1, CosmosVestingV1Beta1, CosmwasmWasmV1, IbcApplicationsInterchainAccountsControllerV1, IbcApplicationsInterchainAccountsHostV1, IbcApplicationsTransferV1, IbcCoreChannelV1, IbcCoreClientV1, IbcCoreConnectionV1, UmmachainUmmacoreConfigurationV1Beta1, UmmachainUmmacoreEscrowV1Beta1, UmmachainUmmacoreFactory, UmmachainUmmacoreMint, UmmachainUmmacoreStarnameV1Beta1,
]);
...
const registry = new Registry([
  ...
  ...UmmachainUmmacoreConfigurationV1Beta1MsgTypes,
  ...UmmachainUmmacoreEscrowV1Beta1MsgTypes,
  ...UmmachainUmmacoreFactoryMsgTypes,
  ...UmmachainUmmacoreMintMsgTypes,
  ...UmmachainUmmacoreStarnameV1Beta1MsgTypes,
