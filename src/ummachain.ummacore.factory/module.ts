...
import { Denom as typeDenom, Params as typeParams } from "./types";
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => ({
  ...
  async sendMsgCreateDenom({ value, fee, memo }: sendMsgCreateDenomParams): Promise<DeliverTxResponse> {
    ...
    try {
      ...
      const msg = this.msgCreateDenom({ value: MsgCreateDenom.fromPartial(value) });
  ...
  async sendMsgUpdateOwner({ value, fee, memo }: sendMsgUpdateOwnerParams): Promise<DeliverTxResponse> {
    ...
    try {
      const { address } = (await signer.getAccounts())[0];
      const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry, prefix });
      const msg = this.msgUpdateOwner({ value: MsgUpdateOwner.fromPartial(value) });
      return await signingClient.signAndBroadcast(address, [msg], fee || defaultFee, memo);
    } catch (e: any) {
  ...
  async sendMsgMintAndSendTokens({ value, fee, memo }: sendMsgMintAndSendTokensParams): Promise<DeliverTxResponse> {
    ...
    try {
      const { address } = (await signer.getAccounts())[0];
      const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry, prefix });
      const msg = this.msgMintAndSendTokens({ value: MsgMintAndSendTokens.fromPartial(value) });
      return await signingClient.signAndBroadcast(address, [msg], fee || defaultFee, memo);
    } catch (e: any) {
  ...
  async sendMsgUpdateDenom({ value, fee, memo }: sendMsgUpdateDenomParams): Promise<DeliverTxResponse> {
    ...
    try {
      const { address } = (await signer.getAccounts())[0];
      const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry, prefix });
      const msg = this.msgUpdateDenom({ value: MsgUpdateDenom.fromPartial(value) });
      return await signingClient.signAndBroadcast(address, [msg], fee || defaultFee, memo);
    } catch (e: any) {
  ...
  async sendMsgBurnToken({ value, fee, memo }: sendMsgBurnTokenParams): Promise<DeliverTxResponse> {
    ...
    try {
      const { address } = (await signer.getAccounts())[0];
      const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry, prefix });
      const msg = this.msgBurnToken({ value: MsgBurnToken.fromPartial(value) });
      return await signingClient.signAndBroadcast(address, [msg], fee || defaultFee, memo);
    } catch (e: any) {
