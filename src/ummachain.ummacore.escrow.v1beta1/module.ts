...
import {
  EventCreatedEscrow as typeEventCreatedEscrow, EventUpdatedEscrow as typeEventUpdatedEscrow, EventCompletedEscrow as typeEventCompletedEscrow, EventRefundedEscrow as typeEventRefundedEscrow, Params as typeParams, TestObject as typeTestObject, TestTimeConstrainedObject as typeTestTimeConstrainedObject, Escrow as typeEscrow,
} from "./types";
...
export const txClient = ({ signer, prefix, addr }: TxClientOptions = { addr: "http://localhost:26657", prefix: "cosmos" }) => ({
  ...
  async sendMsgCreateEscrow({ value, fee, memo }: sendMsgCreateEscrowParams): Promise<DeliverTxResponse> {
    ...
    try {
      ...
      const msg = this.msgCreateEscrow({ value: MsgCreateEscrow.fromPartial(value) });
  ...
  async sendMsgRefundEscrow({ value, fee, memo }: sendMsgRefundEscrowParams): Promise<DeliverTxResponse> {
    ...
    try {
      const { address } = (await signer.getAccounts())[0];
      const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry, prefix });
      const msg = this.msgRefundEscrow({ value: MsgRefundEscrow.fromPartial(value) });
      return await signingClient.signAndBroadcast(address, [msg], fee || defaultFee, memo);
    } catch (e: any) {
  ...
  async sendMsgUpdateEscrow({ value, fee, memo }: sendMsgUpdateEscrowParams): Promise<DeliverTxResponse> {
    ...
    try {
      const { address } = (await signer.getAccounts())[0];
      const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry, prefix });
      const msg = this.msgUpdateEscrow({ value: MsgUpdateEscrow.fromPartial(value) });
      return await signingClient.signAndBroadcast(address, [msg], fee || defaultFee, memo);
    } catch (e: any) {
  ...
  async sendMsgTransferToEscrow({ value, fee, memo }: sendMsgTransferToEscrowParams): Promise<DeliverTxResponse> {
    ...
    try {
      const { address } = (await signer.getAccounts())[0];
      const signingClient = await SigningStargateClient.connectWithSigner(addr, signer, { registry, prefix });
      const msg = this.msgTransferToEscrow({ value: MsgTransferToEscrow.fromPartial(value) });
      return await signingClient.signAndBroadcast(address, [msg], fee || defaultFee, memo);
    } catch (e: any) {
