...
export { MsgReplaceAccountResources, MsgDeleteDomain, MsgDeleteAccountCertificate, MsgRenewAccount, MsgTransferDomain, MsgReplaceAccountMetadata, MsgTransferAccount, MsgRegisterDomain, MsgRenewDomain, MsgAddAccountCertificate, MsgDeleteAccount, MsgRegisterAccount };
  ...
  return {
		...
		async sendMsgReplaceAccountResources({ value, fee, memo }: sendMsgReplaceAccountResourcesParams): Promise<DeliverTxResponse> {
			...
			try {			
				...
				let msg = this.msgReplaceAccountResources({ value: MsgReplaceAccountResources.fromPartial(value) })
		...
		async sendMsgDeleteAccountCertificate({ value, fee, memo }: sendMsgDeleteAccountCertificateParams): Promise<DeliverTxResponse> {
			...
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgDeleteAccountCertificate({ value: MsgDeleteAccountCertificate.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
		...
		async sendMsgRenewAccount({ value, fee, memo }: sendMsgRenewAccountParams): Promise<DeliverTxResponse> {
			...
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgRenewAccount({ value: MsgRenewAccount.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
		...
		async sendMsgTransferDomain({ value, fee, memo }: sendMsgTransferDomainParams): Promise<DeliverTxResponse> {
			...
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgTransferDomain({ value: MsgTransferDomain.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
		...
		async sendMsgReplaceAccountMetadata({ value, fee, memo }: sendMsgReplaceAccountMetadataParams): Promise<DeliverTxResponse> {
			...
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgReplaceAccountMetadata({ value: MsgReplaceAccountMetadata.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
		...
		async sendMsgTransferAccount({ value, fee, memo }: sendMsgTransferAccountParams): Promise<DeliverTxResponse> {
			...
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgTransferAccount({ value: MsgTransferAccount.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
		...
		async sendMsgRenewDomain({ value, fee, memo }: sendMsgRenewDomainParams): Promise<DeliverTxResponse> {
			...
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgRenewDomain({ value: MsgRenewDomain.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
		...
		async sendMsgAddAccountCertificate({ value, fee, memo }: sendMsgAddAccountCertificateParams): Promise<DeliverTxResponse> {
			...
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgAddAccountCertificate({ value: MsgAddAccountCertificate.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
		...
		async sendMsgDeleteAccount({ value, fee, memo }: sendMsgDeleteAccountParams): Promise<DeliverTxResponse> {
			...
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgDeleteAccount({ value: MsgDeleteAccount.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
		...
		async sendMsgRegisterAccount({ value, fee, memo }: sendMsgRegisterAccountParams): Promise<DeliverTxResponse> {
			...
			try {			
				const { address } = (await signer.getAccounts())[0]; 
				const signingClient = await SigningStargateClient.connectWithSigner(addr,signer,{registry, prefix});
				let msg = this.msgRegisterAccount({ value: MsgRegisterAccount.fromPartial(value) })
				return await signingClient.signAndBroadcast(address, [msg], fee ? fee : defaultFee, memo)
			} catch (e: any) {
